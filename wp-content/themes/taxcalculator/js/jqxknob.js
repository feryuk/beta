...
(function (a) {
    ...
    a.extend(a.jqx._jqxKnob.prototype, {
        ...
        , _attatchPointerEventHandlers: function () {
            ...
            var b = null;
            c.addHandler(a('body'), this._getEvent("mousemove"), function (d) {
        ...
        , _mouseMovePointer: function (c) {
            ...
            var trimmedvalue = h.value.toFixed(2) * 1000;
            //var display = num.toFixed(2)
            
            if ($('.cango').val() == 1) {
                
                var weekly_h = $(".weeklyhours").val();
                var hourly_rate = (trimmedvalue) / (52*weekly_h);
                 var hourly_rate = hourly_rate.toFixed(2)
                $(".hourly_rate").html(hourly_rate);
                 $("#slider").slider('value',hourly_rate);
                
                 $(".maininput").val(Math.round(trimmedvalue /10 ) *10);
