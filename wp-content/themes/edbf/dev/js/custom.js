...
jQuery(function ($j) {
    ...
    reinitheight();
    $j(window).bind("reinitheight", reinitheight);
    "use strict";
...
jQuery(function ($j) {
    ...
    if (!$j('.product-zoom').length) {
        ...
        $j('#mainProductImg').css({
            'min-height': $j('#mainProductImg img').height(),
            'min-width': $j('#mainProductImg img').width()
        })
...
jQuery(function ($j) {
    ...
    $j(window).bind('changeBigImage', initProductSlider)
    initProductSlider();
...
jQuery(function ($) {
    ...
    if ($j("#countdown1").length > 0) {
        $j('#countdown1').countdown({until: new Date(2015, 10, 1)});
    }
...
jQuery(function ($j) {
    ...
    "use strict";
    settingsInit();
    $j(window).bind("reinit_isotop", settingsInit);
...
jQuery(function ($j) {
    ...
    $j(window).bind('blogInit', blogInit);
    blogInit();
...
jQuery(function ($j) {
    ...
    settingsInit();
    $j(window).bind("reinit_isotop_gallery", settingsInit);
    function settingsInit() {
...
jQuery(function ($j) {
    ...
    $j('#tglBoxed').click(function () {
        ...
        $j(window).trigger("reinit_isotop");
        $j(window).trigger("reinit_isotop_gallery");
        $j(window).trigger('blogInit');
    });
